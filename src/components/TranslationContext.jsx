...
const translations = {
  en: {
    ...
    dept_name_placeholder: "e.g. Information Technology",
    dept_code_placeholder: "e.g. IT-001",
    ...
    cost_center_placeholder: "e.g. CC-1001",
    location_placeholder: "e.g. Main Office, Riyadh",
    note: "Note",
    ...
    dept_mgmt_coming_soon_toast: "Department management features coming soon",
    assigned: "Assigned",
  },
  ar: {
    // Common - Arabic
    ...
    dept_name_placeholder: "مثال: تقنية المعلومات",
    dept_code_placeholder: "مثال: IT-001",
    dept_description_placeholder: "وصف موجز للقسم...",
    select_manager_placeholder: "اختر رئيس القسم...",
    none_top_level: "لا يوجد (مستوى أعلى)",
    cost_center_placeholder: "مثال: CC-1001",
    location_placeholder: "مثال: المكتب الرئيسي، الرياض",
    note: "ملاحظة",
    department_note: "حالياً، يتم إنشاء الأقسام تلقائياً من بيانات الموظفين. لإنشاء قسم جديد، قم بتعيين موظف له في صفحة إدارة الموظفين.",
    dept_mgmt_coming_soon_toast: "ميزات إدارة الأقسام قريباً",
    assigned: "معين",
  }
};
